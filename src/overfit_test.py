...
# Select the desired model parameters by model name (e.g., 'LightGBM_BO_TPE')
model_name = 'LightGBM_BO_OT'
...
plt.ylim(0, 1.8)  
plt.savefig('../graphs/search_space/light_gbm_train_vs_test(bagging_fraction  is 0.1).png')
