...
def random_search():
    ...
    model = HistGradientBoostingRegressor(random_state=40)
    random_search = RandomizedSearchCV(estimator=model, param_distributions=param_distributions, n_iter=iter, cv=6, scoring='neg_mean_squared_error', n_jobs=-1, random_state=state)
